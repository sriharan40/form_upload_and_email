...
var form = '<!DOCTYPE HTML><html><link rel="stylesheet" type="text/css" href="https://s3-us-west-2.amazonaws.com/telcocode/responsiveform.css"><div id="envelope"><body align="left" style="margin:0 auto;"><header><h2>Personal Details</h2></header><hr>' +
'<form class="form-style-9" action="" method="post" enctype="multipart/form-data">' +
'<label id="choose_country" style="line-height:40px; float:left; margin-top:0px; margin-right:60px;">Choose country </label><select style="padding:10px; width:300px; font-size:32px;" name="country"><option value="Philippines">Philippines</option><option value="Singapore">Singapore</option></select><div style="clear:both;"></div><br /><br />' +
